...
:issue:`2904`: Standardize output columns of functions with different output columns within overloads
...
* :issue:`2707`: Build failure in
  pgRouting 3.7.1 on Alpine
* :issue:`2706`: winnie crashing
...
* :issue:`2517`: Astar code
  simplification.
* :issue:`2521`: Dijkstra code
  simplification.
* :issue:`2522`: bdAstar code
  simplification.
...
* :issue:`1825`: Boost versions
  are not honored
* :issue:`1849`: Boost 1.75.0
  geometry "point_xy.hpp" build error on macOS environment
* :issue:`1861`: vrp functions
  crash server
...
* :issue:`1188`: Removed CGAL
  dependency
* :issue:`1002`: Fixed
  contraction issues:

  * :issue:`1004`: Contracts
    when forbidden vertices do not belong to graph
  * :issue:`1005`: Intermideate
    results eliminated
  * :issue:`1006`: No loss of
    information
...
* :issue:`1152`: Fixes driving
  distance when vertex is not part of the graph
* :issue:`1098`: Fixes windows
  test
* :issue:`1165`: Fixes build for
  python3 and perl5
