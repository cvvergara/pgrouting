...
.. index::
   single: Analysis Family ; pgr_degree
   single: degree
...
- There can be a ``dryrun`` execution and the code used to get the answer will
  ...
  - The code can be used to create an application dependant degree calculation.
...
For the `Edges and Vertices`_ signature:
