...
SELECT CASE WHEN is_version_2() THEN plan(1) ELSE plan(39) END;
...
SELECT * FROM pgr_contraction(
    'graph_e_11_12',
    ARRAY[1]::INTEGER[], 1, ARRAY[11]::integer[], false);
...
SELECT * FROM pgr_contraction(
    'graph_e_5_11_13',
    ARRAY[1]::INTEGER[], 1, ARRAY[3,6,12]::integer[], false);
...
SELECT * FROM pgr_contraction(
    'graph_e_2_3_12',
    ARRAY[1]::INTEGER[], 1, ARRAY[2, 11]::integer[], false);
...
SELECT * FROM pgr_contraction(
    'graph_e_2_3_12',
    ARRAY[1]::INTEGER[], 1, ARRAY[3, 11]::integer[], false);
...
SELECT * FROM pgr_contraction(
    'graph_e_1_3_6',
    ARRAY[1]::INTEGER[], 1, ARRAY[7]::integer[], false);
...
SELECT * FROM pgr_contraction(
    'graph_e_1_3_6',
    ARRAY[1]::INTEGER[], 1, ARRAY[3, 7]::integer[], false);
...
SELECT * FROM pgr_contraction(
    'graph_e_1_3_6',
    ARRAY[1]::INTEGER[], 1, ARRAY[1, 7]::integer[], false);
...
SELECT * FROM pgr_contraction(
    'graph_e_2_3_5_11',
    ARRAY[1]::INTEGER[], 1, ARRAY[2, 6]::integer[], false);
...
SELECT * FROM pgr_contraction(
    'graph_e_2_3_5_11',
    ARRAY[1]::INTEGER[], 1, ARRAY[3, 6]::integer[], false);
...
SELECT * FROM pgr_contraction(
    'graph_e_2_3_5_11',
    ARRAY[1]::INTEGER[], 1, ARRAY[6, 11]::integer[], false);
