...
$BODY$
    ...
    FROM _pgr_dijkstrav4(_pgr_get_statement($1), ARRAY[$2]::BIGINT[], ARRAY[$3]::BIGINT[], $4, true, true, 0, false);
$BODY$
...
$BODY$
    SELECT start_vid, end_vid, agg_cost
    FROM _pgr_dijkstrav4(_pgr_get_statement($1), ARRAY[$2]::BIGINT[], $3::BIGINT[], $4, true, true, 0, false);
$BODY$
LANGUAGE sql VOLATILE STRICT
COST 100
ROWS 1000;
...
$BODY$
    SELECT start_vid, end_vid, agg_cost
    FROM _pgr_dijkstrav4(_pgr_get_statement($1), $2::BIGINT[], ARRAY[$3]::BIGINT[], $4, true, false, 0, false);
$BODY$
LANGUAGE sql VOLATILE STRICT
COST 100
ROWS 1000;
...
$BODY$
    SELECT start_vid, end_vid, agg_cost
    FROM _pgr_dijkstrav4(_pgr_get_statement($1), $2::BIGINT[], $3::BIGINT[], $4, true, true, 0, false);
$BODY$
LANGUAGE sql VOLATILE STRICT
COST 100
ROWS 1000;
...
$BODY$
    SELECT start_vid, end_vid, agg_cost
    FROM _pgr_dijkstrav4(_pgr_get_statement($1), _pgr_get_statement($2), $3, true, 0, false);
$BODY$
LANGUAGE sql VOLATILE STRICT
COST 100
ROWS 1000;
