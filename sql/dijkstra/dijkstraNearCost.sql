...
$BODY$
    ...
    FROM _pgr_dijkstra_v3(_pgr_get_statement($1), ARRAY[$2]::BIGINT[], $3::BIGINT[], directed, true, true, cap, true);
$BODY$
...
$BODY$
    SELECT start_vid, end_vid, agg_cost
    FROM _pgr_dijkstra_v3(_pgr_get_statement($1), $2::BIGINT[], ARRAY[$3]::BIGINT[], directed, true, false, cap, true);
$BODY$
LANGUAGE sql VOLATILE STRICT
COST 100
ROWS 1000;
...
$BODY$
    SELECT start_vid, end_vid, agg_cost
    FROM _pgr_dijkstra_v3(_pgr_get_statement($1), $2::BIGINT[], $3::BIGINT[], directed, true, true, cap, global);
$BODY$
LANGUAGE sql VOLATILE STRICT
COST 100
ROWS 1000;
...
$BODY$
    SELECT start_vid, end_vid, agg_cost
    FROM _pgr_dijkstra_v3(_pgr_get_statement($1), _pgr_get_statement($2), directed, true, cap, global);
$BODY$
LANGUAGE sql VOLATILE STRICT
COST 100
ROWS 1000;
