/*PGR-GNU*****************************************************************
File: contraction_hierarchies.sql
...
COMMENT ON FUNCTION pgr_contraction_hierarchies(TEXT, BIGINT[], BOOLEAN)
IS 'pgr_contraction_hierarchies
- Parameters:
...
- Optional Parameters
    ...
    - directed := true
- Documentation:
    - ${PROJECT_DOC_LINK}/pgr_contraction_hierarchies.html
';
