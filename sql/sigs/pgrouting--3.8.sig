...
pgr_findcloseedges(text,geometry,double precision)
pgr_findcloseedges(text,geometry[],double precision)
pgr_findcloseedges(text,geometry,double precision,boolean)
pgr_findcloseedges(text,geometry[],double precision,boolean)
pgr_findcloseedges(text,geometry,double precision,boolean,boolean)
pgr_findcloseedges(text,geometry[],double precision,boolean,boolean)
pgr_findcloseedges(text,geometry,double precision,integer)
pgr_findcloseedges(text,geometry[],double precision,integer)
_pgr_findcloseedges(text,geometry[],double precision,integer,boolean)
