...
_pgr_corenumbers(text)
pgr_corenumbers(text)
...
_pgr_makebiconnectedplanar(text)
pgr_makebiconnectedplanar(text)
_pgr_makeconnected(text)
pgr_makeconnected(text)
_pgr_makemaximalplanar(text)
pgr_makemaximalplanar(text)
...
_pgr_maxweightedmatching(text)
pgr_maxweightedmatching(text,boolean)
...
_pgr_planarfaces(text)
pgr_planarfaces(text)
