...
#include "./mgDijkstra_driver.h"  // the C++ code of the function

PGDLLEXPORT Datum mgDijkstra(PG_FUNCTION_ARGS);
PG_FUNCTION_INFO_V1(mgDijkstra);
...
process(
    ...
    time_msg(" processing pgr_mgDijkstra", start_t, clock());
