...
#include "./ankurDijkstra_driver.h"  // the C++ code of the function

PGDLLEXPORT Datum ankurDijkstra(PG_FUNCTION_ARGS);
PG_FUNCTION_INFO_V1(ankurDijkstra);
...
process(
    ...
    time_msg(" processing pgr_ankurDijkstra", start_t, clock());
